...
# @app.get('/column_test', response_class=HTMLResponse)
# def get_basic_form(request: Request):
#     return templates.TemplateResponse("column_select_test.html", {"request": request})  # renders HTML form and returns to user (lets us see the form)
